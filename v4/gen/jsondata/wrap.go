...
func wrapValue(globals *model.Globals, valueCell *model.Cell, valueType *model.DataField) interface{} {
...
func wrapSingleValue(globals *model.Globals, valueType *model.DataField, value string) interface{} {
