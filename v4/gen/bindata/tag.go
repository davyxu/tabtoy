...
func MakeTag(globals *model.Globals, tf *model.DataField, fieldIndex int) uint32 {
...
func writePair(globals *model.Globals, structWriter *BinaryWriter, fieldType *model.DataField, goType, value string, fieldIndex int) error {
