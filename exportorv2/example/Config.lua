...
local tab = {
	Sample = {
		...
		{ ID = 102, Name = "舒\"克\"", NumericalRate = 0.7, ItemID = 100, BuffID = { 0, 0 }, Type = 3, SingleStruct = { HP= 10 }, StrStruct = { { HP= 10 } } 	},
		{ ID = 103, Name = "贝\n塔", ItemID = 100, BuffID = { 0, 0 }, Type = 1, SingleStruct = { HP= 10 }, StrStruct = { { HP= 10 } } 	},
		{ ID = 104, Name = "邋遢大王", NumericalRate = 1, ItemID = 100, BuffID = { 0, 0 }, Type = 2, SingleStruct = { HP= 10 }, StrStruct = { { HP= 10 } } 	}
	}, 
