...
local tab = {
	Sample = {
		...
		{ ID = 101, Name = "葫芦\n娃", NumericalRate = 0.8, ItemID = 100, BuffID = { 3, 1 }, Type = "Pig", SkillID = { 1 }, StrStruct = { {  } } 	},
		{ ID = 102, Name = "舒\"克\"", NumericalRate = 0.7, ItemID = 100, BuffID = { 0, 0 }, Type = "Hammer", SkillID = { 0 }, StrStruct = { {  } } 	},
		{ ID = 103, Name = "贝\n塔", ItemID = 100, BuffID = { 0, 0 }, Type = "Monkey", SkillID = { 0 }, StrStruct = { {  } } 	},
		{ ID = 104, Name = "邋遢大王", NumericalRate = 1, ItemID = 100, BuffID = { 0, 0 }, Type = "Pig", SkillID = { 0 }, StrStruct = { {  } } 	}
	}, 
